...
namespace RestaurantManager {
    ...
    public partial class AppDataSet : global::System.Data.DataSet {
        ...
        public partial class UsersDataTable : global::System.Data.TypedTableBase<UsersRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public UsersRow AddUsersRow(string Id, string Name, string Password, string EmailAddress, string UserType) {
...
namespace RestaurantManager.AppDataSetTableAdapters {
    ...
    public partial class UsersTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Users] WHERE (([Id] = @Original_Id) AND ([Name] = @Original_Na" +
                "me) AND ([Password] = @Original_Password) AND ([EmailAddress] = @Original_EmailA" +
                "ddress) AND ([UserType] = @Original_UserType))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Users] ([Id], [Name], [Password], [EmailAddress], [UserType]) " +
                "VALUES (@Id, @Name, @Password, @EmailAddress, @UserType);\r\nSELECT Id, Name, Pass" +
                "word, EmailAddress, UserType FROM Users WHERE (Id = @Id)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Users] SET [Id] = @Id, [Name] = @Name, [Password] = @Password, [EmailAddress] = @EmailAddress, [UserType] = @UserType WHERE (([Id] = @Original_Id) AND ([Name] = @Original_Name) AND ([Password] = @Original_Password) AND ([EmailAddress] = @Original_EmailAddress) AND ([UserType] = @Original_UserType));
SELECT Id, Name, Password, EmailAddress, UserType FROM Users WHERE (Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::RestaurantManager.Properties.Settings.Default.Database1ConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, Name, Password, EmailAddress, UserType FROM dbo.Users";
        ...
        public virtual int Delete(string Original_Id, string Original_Name, string Original_Password, string Original_EmailAddress, string Original_UserType) {
            if ((Original_Id == null)) {
        ...
        public virtual int Insert(string Id, string Name, string Password, string EmailAddress, string UserType) {
            if ((Id == null)) {
        ...
        public virtual int Update(string Id, string Name, string Password, string EmailAddress, string UserType, string Original_Id, string Original_Name, string Original_Password, string Original_EmailAddress, string Original_UserType) {
            if ((Id == null)) {
                throw new global::System.ArgumentNullException("Id");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Name, string Password, string EmailAddress, string UserType, string Original_Id, string Original_Name, string Original_Password, string Original_EmailAddress, string Original_UserType) {
            return this.Update(Original_Id, Name, Password, EmailAddress, UserType, Original_Id, Original_Name, Original_Password, Original_EmailAddress, Original_UserType);
        }
    }
